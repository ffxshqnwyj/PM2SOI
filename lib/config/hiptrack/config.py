...
cfg.MODEL.BACKBONE.ENABLE_CE = True
...
cfg.TEST.SEARCH_SIZE = 320  #改这里
cfg.TEST.EPOCH = 500
cfg.TEST.MEMORY_SCORE_THRESH = 0.5
cfg.TEST.MEMORY_MOTION_IOU = 0.3
cfg.TEST.SECOND_PEAK_RATIO = 0.85
cfg.TEST.SECOND_PEAK_MIN_SCORE = 0.25
cfg.TEST.SECOND_PEAK_MIN_DIST = 2.0
cfg.TEST.MEMORY_FORCE_INTERVAL = 3
cfg.TEST.MOTION_BETA = 0.5          # 乘法 reweight 系数
